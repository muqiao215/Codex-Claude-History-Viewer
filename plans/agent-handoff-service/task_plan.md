...
| HV-H2 | Versioned candidate/handoff envelope consumed by CM headlessly | Full identity/revision, provenance, observed time, source evidence, repository binding, unknown state; contract fixtures in both repos | in_progress: OpenCode and Claude native-reference v2 with independent CM revalidation implemented; broader handoff envelope remains |
